<?php	
	...
	$html .= '</tbody>';
	$html .= '</table>';
	$html .= '<div style="position: absolute; bottom: 0;"><h6 style="font-family: sans-serif; text-align: center; padding-bottom: -15px;">Campos Monteiro 1141 Centro, Av. Josefa Nogueira Monteiro,</h6>';
